 ...
 * @author AHIS
 */
public class OperationTheatrePatientVO extends ValueObject
{
	...
	private String isDeptCheckRequired;
	//public List<OT_EpisodeVO> episodeList;
	private String unitConsultant;
	
	// added by yogender yadav on 3-Oct-2017
		...
		public String getPatotreqno() {
			return patotreqno;
		}

		public void setPatotreqno(String patotreqno) {
			this.patotreqno = patotreqno;
		}
	...
	public String getIsDeptCheckRequired() {
		return isDeptCheckRequired;
	}

	public void setIsDeptCheckRequired(String isDeptCheckRequired) {
		this.isDeptCheckRequired = isDeptCheckRequired;
	}
...
/*
	public List<OT_EpisodeVO> getEpisodeList() {
		return episodeList;
	}

	public void setEpisodeList(List<OT_EpisodeVO> episodeList) {
